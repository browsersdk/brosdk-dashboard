...
> 归档于 2026-07-29。本文件保留阶段 0-34、内核修复及原 Commerce 设想的实施上下文和测试证据，不再作为当前路线图。当前产品状态与后续优先级分别见 [当前状态](../status.md) 和 [正式发布路线](../roadmap.md)。
...
- 该方向已经重新收敛，当前边界见 [跨境电商方向验证](../commerce-roadmap.md)。
